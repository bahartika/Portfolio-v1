...
const ProjectList = () => {
  ...
  // jika mobile, pakai visibleCount. Jika bukan, tampilkan semua
  const displayedRepos = isMobile ? repos.slice(0, visibleCount) : repos;
  ...
  return (
    <section className="w-full md:w-3/4 mx-auto bg-primary flex flex-col items-center justify-center pt-20 pb-10 px-10" id="project">
      ...
      {error && <p className="text-secondary font-quicksand">Error: {error.message}</p>}
